...
for (var i = 1; i <=pageLength; i++) {
  setTimeout( function (i) {
    var mainUrl ="http://www.cromaretail.com/display-product-grid.aspx?strip=strip&test=test&CategoryID=48&MinPrice=7990&MaxPrice=131090&pageNumber=";
    mainUrl = mainUrl +i;
    console.log("http://www.cromaretail.com/display-product-grid.aspx?strip=strip&test=test&CategoryID=48&MinPrice=7990&MaxPrice=131090&pageNumber=1")
    y('http://www.cromaretail.com/display-product-grid.aspx?strip=strip&test=test&CategoryID=48&MinPrice=7990&MaxPrice=131090&pageNumber=1')
        .select([{
          $root: 'article',
          name: 'article h2',
          price: 'article h3',
        ...
        .format(function(obj) {
          ...
          xray(xlink)
              ...
              .run(function(err,result) {
                sub.push(result);
                fs.writeFile ( "./washing/inner/washinginner.json", JSON.stringify (sub, null , '\t' ));
                return result
              })
          obj.link = link;
          thumbDownload.get (obj.image);
          thumbDownload.dest ( './washing' );
          thumbDownload.run ();
        ...
        .delay(2000)
        .write('./washing/washingoutter.json')
  }, interval * i, i);
}
