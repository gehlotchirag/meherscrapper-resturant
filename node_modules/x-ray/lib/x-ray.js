...
Xray.prototype.traverse = function(fn, done) {
  ...
  function next(err, body) {
    ...
    console.log(traveserved + "------"+ href);
    console.log(traveserved.indexOf(href));
    if(traveserved.indexOf(href) == -1)
    {
      console.log("yeg got in");
      traveserved.push(href);
    }
    else
      return done(null);
